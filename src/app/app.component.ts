...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, RouterOutlet, FrontPageComponent, AboutComponent, MyProjectsComponent, ContactComponent, FormationsComponent, FrontParallaxComponent],
})
